...
def update_timer():
    ...
    timer_label.config(text=f'Time left: {minutes}:{seconds:02}', foreground="black", font=("Helvetica", 16, "bold"))
    if timer_value > 0:
...
# Create timer label
timer_value = 600
timer_label = ttk.Label(root, text=f'Time left: {timer_value // 60}:{timer_value % 60:02}', foreground="black", font=("Helvetica", 16, "bold"))
